...
export class TeacherSubjectController {
  ...
  findByTeacher(
    ...
    return this.teacherSubjectService.findByTeacher(teacherId, parseInt(page), parseInt(limit));
  }
  ...
  findBySubject(
    ...
    return this.teacherSubjectService.findBySubject(subjectId, parseInt(page), parseInt(limit));
  }
